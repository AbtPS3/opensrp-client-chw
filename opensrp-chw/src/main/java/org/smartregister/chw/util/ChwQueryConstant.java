...
public interface ChwQueryConstant {
    String ALL_CLIENTS_SELECT_QUERY = "SELECT * FROM (" +
            ...
            "    UNION ALL\n" +
            "    SELECT ec_ovc_register.base_entity_id AS base_entity_id\n" +
            "    FROM ec_ovc_register\n " +
            ...
            "       NULL                                         AS mother_last_name,\n" +
            "       NULL                                         AS mother_middle_name,\n" +
            "       ec_ge_register.last_interacted_with AS last_interacted_with\n" +
            "FROM ec_family_member\n" +
            "         inner join ec_family on ec_family.base_entity_id = ec_family_member.relational_id\n" +
            "         inner join ec_ge_register\n" +
            "                    on ec_family_member.base_entity_id = ec_ge_register.base_entity_id\n" +
            "where ec_family_member.date_removed is null\n" +
            "  AND ec_ge_register.is_closed is 0\n" +
            "  AND  consent_given = 'yes' \n" +
            "  AND ec_family_member.base_entity_id IN (%s)\n" +
            "  AND ec_family_member.base_entity_id NOT IN (\n" +
            "    SELECT ec_kvp_prep_register.base_entity_id AS base_entity_id\n" +
            "    FROM ec_kvp_prep_register where ec_kvp_prep_register.is_closed is 0\n" +
            ...
            "       ec_family_member.base_entity_id,\n" +
            "       ec_family_member.id                          as _id,\n" +
            "       'MVC'                                    AS register_type,\n" +
            "       ec_family_member.relational_id               as relationalid,\n" +
            "       ec_family.village_town                       as home_address,\n" +
            "       NULL                                         AS mother_first_name,\n" +
            "       NULL                                         AS mother_last_name,\n" +
            "       NULL                                         AS mother_middle_name,\n" +
            "       ec_ovc_register.last_interacted_with AS last_interacted_with\n" +
            "FROM ec_family_member\n" +
            "         inner join ec_family on ec_family.base_entity_id = ec_family_member.relational_id\n" +
            "         inner join ec_ovc_register\n" +
            "                    on ec_family_member.base_entity_id = ec_ovc_register.base_entity_id\n" +
            "where ec_family_member.date_removed is null\n" +
            "  AND ec_ovc_register.is_closed is 0\n" +
            "  AND ec_family_member.base_entity_id IN (%s)\n" +
            "  AND ec_family_member.base_entity_id NOT IN (\n" +
            "    SELECT ec_kvp_prep_register.base_entity_id AS base_entity_id\n" +
            "    FROM ec_kvp_prep_register where ec_kvp_prep_register.is_closed is 0\n" +
