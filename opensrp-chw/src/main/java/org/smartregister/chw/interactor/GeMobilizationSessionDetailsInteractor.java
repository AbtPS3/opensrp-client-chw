...
public class GeMobilizationSessionDetailsInteractor extends CoreBaseAncMedicalHistoryInteractor {
    ...
    public void getMemberHistory(final String memberID, final Context context, final BaseAncMedicalHistoryContract.InteractorCallBack callBack) {
        final Runnable runnable = () -> {
            ...
            String[] eventTypes = new String[]{Constants.EVENT_TYPE.GE_MOBILIZATION};
