...
import org.smartregister.chw.model.OvcFamilyProfileMemberModel;
...
public class OvcFamilyProfileMemberFragment extends CoreFamilyProfileMemberFragment {


    public static BaseFamilyProfileMemberFragment newInstance(Bundle bundle) {
        Bundle args = bundle;
        BaseFamilyProfileMemberFragment fragment = new OvcFamilyProfileMemberFragment();
        if (args == null) {
            args = new Bundle();
        }
    ...
    protected void initializePresenter() {
        ...
        presenter = new FamilyProfileMemberPresenter(this, new OvcFamilyProfileMemberModel(), null, familyBaseEntityId, familyHead, primaryCareGiver);
    }
